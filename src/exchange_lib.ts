import { Poseidon, Field, Bool, Group, Circuit, Scalar, PrivateKey, PublicKey, Signature, CircuitValue, prop } from "@o1labs/snarkyjs-web";
...
export class Trade extends CircuitValue {
  ...
  constructor(pairId: Field, isBuy: Bool, price: Field, quantity: Field, timestamp: Field) {
    super();
    this.pairId = pairId;
    this.isBuy = isBuy;
    this.price = price;
...
(Bytes.prototype as any)._fields = [ 
  ['value', Circuit.array(Trade, numTrades) ]
];
